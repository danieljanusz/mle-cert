...
public class Assignment3ModelExecutionRunner {
     ...
     */
    private final static String MODEL_DIR_PATH = "C:\\Users\\Daniel\\workfusion-workspace\\ml_sdk_lessons\\lesson-10\\results_assignment3\\training\\output\\model";

    /**
     * Input directory path to use.
     */
    private final static String INPUT_DIR_PATH = "C:\\Users\\Daniel\\workfusion-workspace\\ml_sdk_lessons\\lesson-10\\data\\validation-cert\\validation";

    /**
     * Output directory path to use.
     */
    public final static String OUTPUT_DIR_PATH = "C:\\Users\\Daniel\\workfusion-workspace\\ml_sdk_lessons\\lesson-10\\results_assignment3\\extract";
